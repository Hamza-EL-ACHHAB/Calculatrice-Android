package com.example.calculatriceandroid;
...
public class CalculStandard extends AppCompatActivity implements View.OnClickListener,View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calcul_standard);
